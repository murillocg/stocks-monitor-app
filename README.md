...
- [x] Stocks that dropped over than 15% since their highest price - Check daily
- [x] % gain/loss in the last week - Check weekly
- [x] % gain/loss in the last month - Check monthly
- [ ] % gain/loss in the last 6 months - Check monthly
